...
b8="/mushroom"
b9="/done"
kb.add(b1).add(b2).add(b3).add(b4).insert(b5).add(b6).insert(b7).insert(b8).add(b9)
...
async def helper(message: types.Message):
        globals()
        price = peperoni * size
        await message.reply(text=f'ця піца коштуватиме {price}, щоб підтвердити покупку використайте /done')
